        ...
        <div>
            ...
            <div className='absolute'>
                <div className=' bg-black h-screen w-screen'>
                    <img className='h-screen object-cover w-screen bg-blend-lighten hover:bg-blend-darken opacity-50'
                        src={netflixBgImg}
                        alt='BG-img'
                    />
                </div>
            ...
            <form onSubmit={(e) => e.preventDefault()} className='absolute w-5/6 md:w-[30%] h-[87.1%] p-[65px] bg-black   flex flex-col text-white m-auto left-0 right-0 my-[100px] bg-opacity-70'>
